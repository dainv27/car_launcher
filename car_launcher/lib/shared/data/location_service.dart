...
class VehicleTrackingSyncClient {
  ...
  Future<void> ensureDeviceRegistered() async {
    ...
    final device = Device(
      ...
      serialNumber: StringUtils.toStringValue(deviceInfo['serial']),
      model: StringUtils.toStringValue(deviceInfo['model']),
      metadata: deviceInfo,
    );
  ...
  static String _buildDeviceName(Map<String, dynamic> deviceInfo) {
    final manufacturer = StringUtils.toStringValue(deviceInfo['manufacturer']);
    final model = StringUtils.toStringValue(deviceInfo['model']);
...
final vehicleTrackingProvider =
    StateNotifierProvider<VehicleTrackingNotifier, VehicleTrackingState>((ref) {
      ...
      final notifier = VehicleTrackingNotifier(
        auth,
        syncClient: VehicleTrackingSyncClient(httpClient: httpClient),
      );
