...
/// Shared presentational primitives used by the vehicle/tracking/trip/
/// geofence/alert feature screens, factored out of the per-page
/// `_GlassPanel` / `_InfoRow` / error-view copies.
